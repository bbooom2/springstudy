DROP TABLE USER_ACCESS; -- 접속 기록 
DROP TABLE USER;

CREATE TABLE USER (
    USER_NO NUMBER NOT NULL,
    ID      VARCHAR2(40 BYTE) NOT NULL UNIQUE,  -- ID정규식에 반영 
    ...
    ROAD_ADDRESS VARCHAR2(100 BYTE),            -- 도로명 주소 
    JIBUN_ADDRESS VARCHAR2(100 BYTE),           -- 지번주소 
    DETAIL_ADDRESS VARCHAR2(100 BYTE),          --상세주소 
    EXTRA_ADDRESS   VARCHAR2(100 BYTE),         --참고 항목 
    AGREE NUMBER NOT NULL,                      --동의여부(1:위치, 2:이벤트, 3:위치+이벤트)
    JOINED_AT DATE,                             -- 가입일 
